class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name("based_near_label", :facetable), limit: 5, label: 'Based near'
    ...
    config.add_index_field solr_name("crn", :stored_searchable), label: "CRN", itemprop: 'keywords'
    #config.add_index_field solr_name("date_uploaded", :stored_sortable, type: :date), itemprop: 'datePublished', helper_method: :human_readable_date
    #config.add_index_field solr_name("date_modified", :stored_sortable, type: :date), itemprop: 'dateModified', helper_method: :human_readable_date
    config.add_index_field solr_name("year_course_taught", :stored_searchable), itemprop: 'keywords'
    config.add_index_field solr_name("term_course_taught", :stored_searchable), itemprop: 'keywords'
    ...
    config.add_show_field solr_name("crn", :stored_searchable)
    config.add_show_field solr_name("year_course_taught", :stored_searchable)
    ...
    config.add_show_field solr_name("course_prefix_number_concat", :stored_searchable)
    ...
    config.add_sort_field "title asc", label: "Title [A-Z]"
    config.add_sort_field "title desc", label: "Title [Z-A]"
